...
document.customCreateElement('script', {src:`https://maps.googleapis.com/maps/api/js?key=${params.key}&callback=initMap&libraries=&v=weekly`, defer:true}, document.querySelector('head'))
...
//
    ...
    function buildInput(feature, storedValue) {
        ...
        var saveButton = document.customCreateElement('button', {
            ...
            onclick:  (e) => {
              console.log(e);
              feature.j.savedContent = textField.value}
        }, inputContainer)
